...
The gradient of a differentiable function has the following properties.
	\begin{enumerate}
		...
		\item $\nabla(f+g)=\nabla f + \nabla g$
		\item $\nabla(f \cdot g)=(\nabla f)g+g\nabla f$
		\item $nabla\left(\frac{f}{g}\right)=\frac{g \nabla f-f \nabla g}{g^2}$
	\end{enumerate}
\end{thm}
