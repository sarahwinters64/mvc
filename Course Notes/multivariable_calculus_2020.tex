...
Note that both of these hypotheses of Lemma \ref{lem:some_dot_products} are true for an orthonormal set of vectors $\{\bbr_1,\bbr_1\}$. \footnote{See Section 5.4 of my Linear Algebra Notes for the definition of an orthonormal set of vectors.}
...
\fixme{Skip. Maybe cover next year. Needs to be finished.}
...
\fixme{Skip this. Maybe cover next year.}
...
\section{Normed Linear Spaces}\label{app:topology}
